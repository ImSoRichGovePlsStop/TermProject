...
public class UpgradeOptionUI : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
{
    ...
    private UpgradeStationUI _stationUI;
    ...
    public void Init(ModuleInstance instance, UpgradeStationUI stationUI)
    {
        _instance = instance;
        _stationUI = stationUI;
        ...
        if (levelText != null)
            levelText.text = $"Lv.{instance.Level} → <color=#88ff88>Lv.{instance.Level + 1}</color>";

        if (descriptionText != null && instance.Data.moduleEffect != null)
        {
            string currentDesc = instance.Data.moduleEffect.GetDescription(
    ...
    public void OnPointerClick(PointerEventData e)
    {
        ...
        _stationUI.OnOptionSelected(_instance);
    }
